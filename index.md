...
You can access my CV [here](assets/files/cv.pdf) (last updated: August 2026). **I am on the 2026-2027 academic job market**.
...
## Working Papers
1. When Legitimacy Becomes a Liability: How Economic Security Shapes Global Firms' Socio-Political Strategy **[Job Market Paper]**
   ...
   How do foreign multinational enterprises (MNEs) respond when host country politicians frame them as national security threats? I argue that economic security (ES)---the framing of foreign investment as a national security threat---shapes how MNEs choose between lobbying and social investment. Under emergent ES risk, MNEs substitute social investment for lobbying to establish stakeholder legitimacy. Once ES risk consolidates, however, high-profile social investment becomes a liability, as local embeddedness now reads as suspicious foreign influence, so MNEs scale back both lobbying and social investment. Using a staggered difference-in-differences design that links an original dataset of ES bills in the U.S. Congress (2005--2024) to 634 foreign MNEs operating in the United States (2013--2024), I find empirical support for these propositions. Twenty-one interviews with corporate and policy professionals further reveal corporate logic and actions under different risk levels. Moreover, an additional test on 5,484 legislator-session observations shows that ES bill sponsorship rises only when competitive elections coincide with constituent exposure to foreign import competition, confirming the electoral nature of the risk. Overall, this paper shows that the trade-off between corporate political and social strategies depends on the ES risk's developmental stages, offering managerial guidance for global firms to operate amid rising geopolitical tension.
    </p>
     </details>
